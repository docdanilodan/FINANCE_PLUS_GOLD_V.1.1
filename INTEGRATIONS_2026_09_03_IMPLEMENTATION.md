...
3. **OpenAI** - nuovo cruscotto costi read-only raggruppato per progetto e voce di costo, con mapping opzionale verso i moduli FinancePlus.
...
```text
OPENAI_ADMIN_KEY
FINANCEPLUS_OPENAI_PROJECT_LABELS_JSON
...
3. Creare progetti OpenAI separati per modulo e mappare i relativi ID nel JSON delle etichette.
